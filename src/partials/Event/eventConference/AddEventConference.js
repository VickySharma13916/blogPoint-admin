      ...
      header={
        <>
          <IconButton
            ...
            className="p-0 me-2"
          />
          <h6 className="mb-0">Add Event Conference</h6>
        </>
      }
    >
      {preview ? (
          ...
          <Row>
            ...
            <Col xs={12}>
              <Input
                type="text"
                id="metaTitle"
                name="Event Conference Meta Title"
...
AddEventConference.propTypes = {
  width: PropTypes.string,
  refresh: PropTypes.func,
  userData: PropTypes.object,
};

AddEventConference.defaultProps = {
  width: "75%",
  refresh: () => null,
  userData: null,
};
...
const mapDispatchToProps = (dispatch) => ({
  ...
  handleAddEventConference: (payload) =>
    dispatch(performPostEventConference(payload)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AddEventConference);
