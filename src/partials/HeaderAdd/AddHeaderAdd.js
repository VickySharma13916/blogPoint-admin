...
const AddHeaderAdd = ({
  ...
  const onSubmit = async (data) => {
    ...
    const result = await handleAddHeaderAdd(newData);
    if (result.status === 200) {
      history.goBack();
    }
  };
      ...
      header={
        <>
          <IconButton
            ...
            className="p-0 me-2"
          />
          <h6 className="mb-0">Add Header Advertisement</h6>
        </>
      }
    >
            ...
            <div className="image-uploader-container">
              ...
              <div className="image-container">
                {headerAddImage ? (
                  ...
                  <Avatar
                    src={BACKEND_URL + headerAddImage}
...
AddHeaderAdd.propTypes = {
  width: PropTypes.string,
  refresh: PropTypes.func,
  userData: PropTypes.object,
};

AddHeaderAdd.defaultProps = {
  width: "100%",
  refresh: () => null,
  userData: null,
};
...
const mapDispatchToProps = (dispatch) => ({
  handleAddHeaderAdd: (payload) => dispatch(performPostHeaderAdd(payload)),
  handleAddImageCourse: (payload) =>
    dispatch(performImagePosthHeaderAdd(payload)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AddHeaderAdd);
