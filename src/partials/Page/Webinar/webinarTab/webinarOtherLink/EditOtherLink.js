...
import { performUpdateWebinarDetail } from "../../../../../redux/actionCreators/webinarCreators";
...
const EditOtherLink = ({ submitting, handleEditOtherLink, history }) => {
  ...
  const {
    ...
    defaultValues: {
      webinarOtherName: userData?.webinarOtherName,
      webinarOtherLink: userData?.webinarOtherLink,
    },
  });
