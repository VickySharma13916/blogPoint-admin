      ...
      header={
        <>
          <IconButton
            ...
            className="p-0 me-2"
          />
          <h6 className="mb-0">Add Testimonial</h6>
        </>
      }
    >
        ...
        <Row>
          <Col xs={12}>
            <Input
              ...
              id="studentName"
              name="studentName"
              label={"workshop Testimonial Name"}
          ...
          <Col xs={12}>
            <Input
              ...
              label={"workshop Testimonial Description"}
...
const mapDispatchToProps = (dispatch) => ({
  ...
  handleAddImageCourse: (payload) =>
    dispatch(performPostImageWorkshop(payload, "studentImage")),
});
